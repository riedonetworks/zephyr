...
#define W25Q128_LUT_LENGTH (11U * 4U)
...
__dtcm_data_section static const u32_t w25q128LUT[W25Q128_LUT_LENGTH] = {
	...
	/* Erase 32 KiB block */
	[4 * NOR_CMD_LUT_SEQ_IDX_ERASE32KBLOCK] = FLEXSPI_LUT_SEQ(
		kFLEXSPI_Command_SDR, kFLEXSPI_1PAD, 0x52,
		kFLEXSPI_Command_RADDR_SDR, kFLEXSPI_1PAD, 0x18
	),

	/* Erase 64 KiB block */
	[4 * NOR_CMD_LUT_SEQ_IDX_ERASE64KBLOCK] = FLEXSPI_LUT_SEQ(
	...
	[4 * NOR_CMD_LUT_SEQ_IDX_WRITESTATUSREG2] = FLEXSPI_LUT_SEQ(
		kFLEXSPI_Command_SDR, kFLEXSPI_1PAD, 0x31,
